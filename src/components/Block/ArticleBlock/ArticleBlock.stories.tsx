...
import Article, { type IPostOverviewCard } from './ArticleBlock';
import { mockArticleBlockProps } from './ArticleBlock.mock';

export default {
  title: 'Components/Block/ArticleBlock',
  component: Article,
